...
export default function Footer({ style = {} }) {
  return (
    <div style={{
      ...
      gap:8, marginTop:24, color:"var(--text2, #b0bdd4)", fontSize:15, fontWeight:700, ...style,
    }}>
      <span>Developed By <strong style={{ color:"var(--accent, #00d4ff)" }}>Akshith Sai Kondamadugu</strong></span>
      <span style={{ opacity:0.5 }}>·</span>
      <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer"
        style={{ display:"inline-flex", alignItems:"center", gap:6, color:"inherit", textDecoration:"none", fontWeight:700, fontSize:15 }}
