...
export default function GithubBadge({ size = 16 }) {
  return (
    <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer"
      title="Developed By Akshith Sai Kondamadugu — View on GitHub"
      style={{
        display:"inline-flex", alignItems:"center", gap:6,
        color:"#b0bdd4", textDecoration:"none", fontSize:13, fontWeight:800,
        border:"1px solid #2a3550", borderRadius:7, padding:"5px 11px",
        background:"#1a2030",
      }}
