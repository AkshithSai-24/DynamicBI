...
def dataset_visualization_agent(state):
    ...
    if len(numeric_cols) > 1:
        ...
        if clean_df.shape[1] > 1:
            ...
            with open("dashboard/chart_data/correlation_heatmap.json", "w", encoding="utf-8") as f:
    ...
    with open("dashboard/chart_data/dataset_statistics_summary.json", "w", encoding="utf-8") as f:
